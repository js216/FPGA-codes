...
## LEDs
set_property -dict { PACKAGE_PIN A17   IOSTANDARD LVCMOS33 } [get_ports { device_ready }]; #IO_L12N_T1_MRCC_16 Sch=led[1]
...
#set_property -dict { PACKAGE_PIN J3    IOSTANDARD LVCMOS33 } [get_ports { out[9] }]; #IO_L7P_T1_AD6P_35 Sch=pio[10]
...
set_property -dict { PACKAGE_PIN R2    IOSTANDARD LVCMOS33 } [get_ports { F[2] }]; #IO_L1P_T0_34 Sch=pio[28]
